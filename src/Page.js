...
import { FaBars, FaChevronCircleDown, FaChevronCircleUp, FaCopyright, FaLink, FaPaintBrush, FaSortAlphaDown, FaSortDown } from "react-icons/fa"
...
export default function Page() {
  ...
  return (
    <div className='w-full'>
      <header className='bg-blue-600 flex justify-between items-center h-10 text text-white sm:h-11 md:h-14 xl:h-16'>
      ...
      <section>
        ...
        <div className=' bg-newblue h-100 pt-3 text-center pb-3 sm:pt-5 lg:pt-8 xl:pt-12 md:pt-7'>
          <div className='lg:flex justify-center gap-2'>  <h1 className='text-lg font-bold lg:text-xl xl:text-2xl'>Effortless URL Shortening For </h1><span className='text-lg font-bold text-blue-600 lg:text-xl xl:text-2xl '>Everyone</span></div>
          <p className=' text-md text-black font-semibold md:pt-1 lg:pt-4 md:text-lg xl:text-xl'>Effortlessly create short links for social media,marketing and more</p>
          ...
          <p className='mt-4 text-sm md:text-base md:mb-6 lg:mb-8 lg:text-lg'>By using this our url shortener you agree to our terms and condition</p>
        </div>
        ...
        <div className='flex flex-col justify-center items-center gap-6 md:px-5 md:flex-row xl:gap-24 '>
          ...
          <div className='w-64 bg-newblue h-72 rounded-xl text-center pt-10 px-5 lg:w-72 lg:h-96 sm:w-72 sm:h-80'>
            ...
            <p className='text-sm mt-4 sm:text-base lg:text-lg xl:text-xl'>Weblify offers A "<span>Custom Link</span>solution" for users to craft and customize their short links.</p>
          </div>
          <div className=' bg-newblue w-64 h-72 rounded-xl text-center pt-10 px-5  lg:w-72 lg:h-96 sm:w-72 sm:h-80 '>
            <div className='bg-black w-10 h-10 rounded-full flex justify-center items-center m-auto sm:w-12 sm:h-12 lg:w-16 lg:h-16 md:h-14 md:w-14'><svg className='text-lg text-white lg:text-xl' width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="streamline:money-graph-bar-product-data-bars-analysis-analytics-graph-business-chart" clip-path="url(#clip0_404_117)">
                <path id="Vector" d="M13.5 13.5H0.5V0.5H4.5V13.5V6.5H8.5V13.5V3.5H12.5V13.5" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
              </g>
              <defs>
            ...
            <p className='text-sm mt-4  md:mt-1 sm:text-base lg:text-lg xl:text-xl'>Weblify is an advanced link analytics platform that <span>tracks clicks</span>on short links and provides extensive statistics to help you measure the effectiveness of your short links</p>
          </div>

        </div>
        <div className=' bg-newblue mt-12 pt-10 pb-10'>
          <div className='text-center  '>
            <h1 className='text-lg font-bold xl:text-xl'>FAQ</h1>
          ...
          <div className='mx-5 sm:mx-8 md:mx-12 lg:mx-16 xl:mx-24 '>
            <div className='mt-10'>
              <div className='flex justify-between  pb-2'>  <p className='text-base font-medium sm:text-base md:text-lg'>What is a URL shortener?</p>{showinfo1 ? <FaChevronCircleDown onClick={displayinfo1} /> : <FaChevronCircleUp onClick={displayinfo1} />}</div>
            ...
            <div>
              <div className='flex justify-between  pb-2 mt-2'> <p className='text-base font-medium sm:text-base md:text-lg'>How do i use the URL shortener?</p>{showinfo2 ? <FaChevronCircleDown onClick={displayinfo2} /> : <FaChevronCircleUp onClick={displayinfo2} />}</div>
            ...
            <div>
              <div className='flex justify-between  pb-2  mt-2'> <p className='text-base font-medium sm:text-base md:text-lg'>Can i customize my short links?</p>{showinfo3 ? <FaChevronCircleDown onClick={displayinfo3} /> : <FaChevronCircleUp onClick={displayinfo3} />}</div>
            ...
            <div>
              <div className='flex justify-between  pb-2  mt-2'> <p className='text-base font-medium sm:text-base md:text-lg'>Are there analytics available for my short links?</p>{showinfo4 ? <FaChevronCircleDown onClick={displayinfo4} /> : <FaChevronCircleUp onClick={displayinfo4} />}</div>
            ...
            <div>
              <div className='flex justify-between  pb-2  mt-2'> <p className='text-base font-medium sm:text-base md:text-lg'>Is there a limit to the number of links i can shorten?</p>{showinfo5 ? <FaChevronCircleDown onClick={displayinfo5} /> : <FaChevronCircleUp onClick={displayinfo5} />}</div>
            ...
            <div>
              <div className='flex justify-between pb-2  mt-2'> <p className='text-base font-medium sm:text-base md:text-lg'>How long are my shorts links generated by your platform?</p>{showinfo6 ? <FaChevronCircleDown onClick={displayinfo6} /> : <FaChevronCircleUp onClick={displayinfo6} />}</div>
