    ...
    <div className='w-full'>
      ...
      <section>
        ...
        <div className=' bg-newblue h-100 pt-28 text-center pb-10 sm:pt-32 lg:pt-40 xl:pt-44 md:pt-36 '>
          ...
          <p className='pt-2  text-base text-black font-semibold sm:pt-4 md:pt-5 lg:pt-6 xl:pt-6 md:text-lg xl:text-2xl lg:text-xl'>Effortlessly create short links for social media,<span className='flex flex-col'>marketing and more.</span></p>
        ...
        <div className=' bg-newblue mt-12 pt-10 pb-10'>
          ...
          <div className='mx-5 sm:mx-8 md:mx-12 lg:mx-16 xl:mx-24 '>
            <div className='mt-10'>
              ...
              <div className='border-b-r border-iconblue overflow-hidden '><p className={`xl:text-lg mb-2 ${showinfo1 ? '-translate-y-20 hidden ' : '-translate-y- 20'}`}>A url shortener is used in making the url of a website short and simple.</p></div>
            </div>
            <div>
              ...
              <div className='border-b-r border-iconblue'><p className={`xl:text-lg mb-2 ${showinfo2 ? '-translate-y-20 hidden ' : '-translate-y- 20'}`} >its simple all you have to do is paste in your long link and press the shorten button.</p></div>
            </div>
            <div>
              ...
              <div className='border-b-r border-iconblue'><p className={`xl:text-lg mb-2 ${showinfo3 ? '-translate-y-20 hidden ' : '-translate-y- 20'}`}>yes,you can customize your shortened links,all you have to do is to ..............</p></div>
            </div>
            <div>
              ...
              <div className='border-b-r border-iconblue'><p className={`xl:text-lg mb-2 ${showinfo4 ? '-translate-y-20 hidden ' : '-translate-y- 20'}`} >yes there are analytics available for your short links,i dont even know what is analytics.......</p></div>
            </div>
            <div>
              ...
              <div className='border-b-r border-iconblue'><p className={`xl:text-lg mb-2 ${showinfo5 ? '-translate-y-20 hidden ' : '-translate-y- 20'}`} >no, you can shorten your links as many as you want my dear ........................</p></div>
            </div>
            <div>
              ...
              <div className='border-b-r border-iconblue'><p className={`xl:text-lg mb-2 ${showinfo6 ? '-translate-y-20 hidden ' : '-translate-y- 20'}`} >just few manys with a strong connection your shortened links are ready</p></div>
            </div>
          </div>
        </div>
