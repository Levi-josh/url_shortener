      ...
      <section>
        ...
        <div className='flex flex-col justify-center items-center gap-6 md:px-5 md:flex-row xl:gap-24 '>
          <div className='w-64 bg-newblue  h-72 rounded-xl text-center pt-10 px-5 lg:w-72 lg:h-96 sm:w-72 sm:h-80'>
            ...
            <p className='text-sm mt-4 sm:text-base  '>Weblify is A <span className='text-blue-600 font-semibold'> Url Shortener</span>.It offers a simple and fast way to shorten and share your urls.</p>
          </div>
          <div className='w-64 bg-newblue h-72 rounded-xl text-center pt-10 px-5 lg:w-72 lg:h-96 sm:w-72 sm:h-80'>
            ...
            <p className='text-sm mt-4 sm:text-base  '>Weblify offers A "<span className='text-blue-600 font-semibold'>Custom Link</span> solution" for users to craft and customize their short links.</p>
          </div>
          <div className=' bg-newblue w-64 h-72 rounded-xl text-center pt-10 px-5  lg:w-72 lg:h-96 sm:w-72 sm:h-80 '>
            ...
            <p className='text-sm mt-4  md:mt-1 sm:text-base '>Weblify is an advanced link analytics platform that <span className='text-blue-600 font-semibold'>tracks clicks</span> on short links and provides extensive statistics to help you measure the effectiveness of your short links.</p>
          </div>
