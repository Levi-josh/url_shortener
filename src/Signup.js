      ...
      {showForm ? (
        ...
        <div className="lg:hidden flex justify-center h-full ">
          ...
          <div className="flex flex-col justify-center h-full">
            ...
            <div className=" bg-newblue text-center relative  rounded-lg shadow-lg mt-12 px-2 sm:px-4 lg:hidden" >
      ...
      {showForm ? (
        ...
        <div className="hidden lg:inline">
          ...
          <div className="flex  items-center  justify-center h-screen md:h-auto min-h-screen bg-white">
            ...
            <div className=" bg-newblue xl:w-121 w-122 text-center pt-10 pb-10 md:mr-4  lg:mr-10 lg:px-6 lg:pb-14 md:pt-14 md:pb-14 lg:pt-12 md:px-4 relative  rounded-lg shadow-lg hidden  lg:block" >
              <h3 className="font-bold text-xl lg:text-2xl "> Create Account</h3>
              <form onSubmit={handleSubmit}>
                {error.message ? <h4 className="text-red-600 text-sm">{error.message}</h4> : null}
                <input type="email" placeholder="Email Address" className=" md:mt-12 sm:mt-12 md:mb-10  lg:mb-10 pl-3 w-full  pt-1 rounded-lg pb-1 border-2 border-gray-300 mb-10 outline-none text-lg " required value={formValues.email} name="email" onChange={handleFormChanges} /> <br />
            ...
            <div className="text-center w-80 hidden  lg:block">
